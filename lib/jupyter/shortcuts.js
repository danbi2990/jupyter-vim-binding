define([
  ...
  exports.get_default_command_shortcuts = function get_default_command_shortcuts() {
    return {
      ...
      'ctrl-r': 'jupyter-notebook:rename-notebook',
      ...
      'ctrl-shift-o': 'jupyter-notebook:insert-cell-above',
      ...
      'ctrl-h': 'vim-binding-normal:collapse-output',
      'ctrl-l': 'vim-binding-normal:expand-output',
      'ctrl-cmd-h': 'jupyter-notebook:toggle-cell-output-scrolled',
      'ctrl-shift-h': 'vim-binding-normal:collapse-all-output',
      'ctrl-shift-l': 'vim-binding-normal:expand-all-output',
      'ctrl-cmd-l': 'jupyter-notebook:toggle-all-cells-output-scrolled'
    };
  };
  ...
  exports.get_default_edit_shortcuts = function get_default_edit_shortcuts() {
    return {
      ...
      'ctrl-o': 'vim-binding:insert-cell-below',
      'ctrl-shift-o': 'vim-binding-normal:collapse-output',
