define([
  ...
  exports.get_default_command_shortcuts = function get_default_command_shortcuts() {
    return {
      ...
      'cmd-ctrl-enter': 'jupyter-notebook:restart-kernel-and-run-all-cells',
      'cmdtrl-alt-1': 'jupyter-notebook:change-cell-to-code',
      'ctrl-shift-i': 'vim-binding:change-cell-to-code',
      'cmdtrl-alt-2': 'jupyter-notebook:change-cell-to-markdown',
      'm': 'vim-binding:change-cell-to-markdown',
      'cmdtrl-alt-3': 'jupyter-notebook:change-cell-to-raw',
      ...
      'ctrl-shift-r': 'jupyter-notebook:rename-notebook',
      // 'ctrl-s': 'toc2:toggle-toc',
      ...
      // 'z,o': 'vim-binding:toggle-cell-output-scrolled',
      // 'z,shift-o': 'vim-binding:toggle-all-cells-output-scrolled',
      ...
      'ctrl-c': 'jupyter-notebook:cut-cell',
      'ctrl-v': 'jupyter-notebook:paste-cell-below',
      'ctrl-f': 'vim-binding:toggle-cell-output-scrolled',
      'ctrl-shift-n': 'vim-binding:toggle-all-cells-output-scrolled',
      'ctrl-h': 'vim-binding:collapse-output',
      'ctrl-l': 'vim-binding:expand-output',
      'ctrl-shift-h': 'vim-binding:collapse-all-output',
      'ctrl-shift-l': 'vim-binding:expand-all-output',
  ...
  exports.get_default_edit_shortcuts = function get_default_edit_shortcuts() {
    return {
      ...
      'cmdtrl-enter': 'jupyter-notebook:run-cell',
      // 'cmdtrl-shift-enter': 'jupyter-notebook:run-all-cells',
      'cmd-ctrl-enter': 'jupyter-notebook:confirm-restart-kernel-and-run-all-cells',
      'cmdtrl-alt-1': 'vim-binding:change-cell-to-code',
      'ctrl-shift-i': 'vim-binding:change-cell-to-code',
      'cmdtrl-alt-2': 'vim-binding:change-cell-to-markdown',
      // 'm': 'vim-binding:change-cell-to-markdown',
      'cmdtrl-alt-3': 'vim-binding:change-cell-to-raw',
      'cmdtrl-shift-p': 'jupyter-notebook:show-command-palette',
      ...
      // 'z,a': 'vim-binding:toggle-cell-output-collapsed',
      ...
      // 'b': 'vim-binding:insert-cell-below',
      // 'a': 'vim-binding:insert-cell-above',
